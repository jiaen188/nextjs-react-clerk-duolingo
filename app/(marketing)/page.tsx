...
export default function Home() {
  return <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center p-4 gap-2">
    ...
    <div className="flex flex-col items-center gap-y-8">
      <h1 className="text-xl lg:text-3xl font-bold text-center text-neutral-600 max-w-[480px]">Learn, practice and improve your English with Lingo</h1>
      <div className="flex flex-col items-center max-w-[330px] w-full gap-y-4">
        <ClerkLoading>
